                                            ...
                                            <table class="body-text">
                                                <tr>
                                                    <td class="body-text-cell">
                                                        Para redefinir a sua senha acesse o link
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><a id="btn-redefine" href="<?= $link;?>" align="center">Redefinir Senha</a></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="body-signature-block">
                                                <tr>
                                                    <td class="body-signature-cell">
                                                        <p>Obrigado!</p>
                                                        <p class="body-signature pull-right">Copyright &copy; <?= date('Y');?> </p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
