...
<section class="container col-md-4">
    ...
    <form class="form" action="<?= $router->route("auth.forgot"); ?>" method="post" autocomplete="off">
        <div class="card border-success ">
            ...
            <div class="card-footer">
                <a class="btn btn-primary float-right" href="<?= $router->route("web.login")?>" title="Login"><strong>Voltar ao Login</strong> </a>
            </div>
