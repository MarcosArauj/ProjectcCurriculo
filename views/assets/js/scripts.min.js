...
return!1})})});$(document).ready(function(){$('#filtro').on("change",function(){let filtro=$('#filtro').val();if(filtro=="Formação"){$('#selecao').css("display","none");$('#formacao').css("display","block");$('#sexo').css("display","none")}else if(filtro=="Sexo"){$('#selecao').css("display","none");$('#formacao').css("display","none");$('#sexo').css("display","block")}else if(filtro==""){$('#selecao').css("display","block");$('#formacao').css("display","none");$('#sexo').css("display","none")}})});function verifica_cpf(cpf){var numeros,soma,digitos,i,resultado,digitos_iguais;digitos_iguais=1;cpf=removeMascara(cpf,".");cpf=removeMascara(cpf,"-");if(cpf.length<11)
