...
return tooltipData}})}
var widgetsTooltip=$.ui.tooltip}));function removeMascara(str,sub){var i=str.indexOf(sub);var r="";if(i==-1)return str;{r+=str.substring(0,i)+removeMascara(str.substring(i+sub.length),sub)}
return r}
$('#cep').blur(function(e){var cep=$('#cep').val();cep=removeMascara(cep,".");cep=removeMascara(cep,"-");var url="http://viacep.com.br/ws/"+cep+"/json"
pesquisarCEP(url)});function pesquisarCEP(endereco){$.ajax({type:"GET",url:endereco,async:!1}).done(function(data){console.log(data);$('#bairro').val(data.bairro);$('#endereco').val(data.logradouro);$('#cidade').val(data.localidade);$('#estado').val(data.uf)}).fail(function(){console.log("Erro")})}
jQuery(document).ready(function($){$('#mostrar_senha').on("click",function(e){e.preventDefault();if($('#senha').attr('type')==='password'){$('#senha').attr('type','text');$('#mostrar_senha').attr('class','fa fa-eye')}else{$('#senha').attr('type','password');$('#mostrar_senha').attr('class','fa fa-eye-slash')}});$('#mostrar_confirma_senha').on("click",function(e){e.preventDefault();if($('#confirma_senha').attr('type')==='password'){$('#confirma_senha').attr('type','text');$('#mostrar_confirma_senha').attr('class','fa fa-eye')}else{$('#confirma_senha').attr('type','password');$('#mostrar_confirma_senha').attr('class','fa fa-eye-slash')}});$('#mostrar_senha_alterar').on("click",function(e){e.preventDefault();if($('#senha').attr('type')==='password'||$('#confirma_senha').attr('type')==='password'||$('#senhatual').attr('type')==='password'){$('#senhatual').attr('type','text');$('#senha').attr('type','text');$('#confirma_senha').attr('type','text');$('#mostrar_senha_alterar').val('Ocultar Senhas')}else{$('#senhatual').attr('type','password');$('#senha').attr('type','password');$('#confirma_senha').attr('type','password');$('#mostrar_senha_alterar').val('Mostrar Senhas')}})});$(document).ready(function(){$('#sim').on('click',function(){$('#nome_social').attr('disabled',!1);$('#nome_social').css('background-color','#1C1F27');$('#mens_social').attr("class","success-enabled")});$('#nao').on('click',function(){$('#nome_social').attr('disabled',!0);$('#nome_social').css('background-color','#4b4b4b');$('#mens_social').attr("class","success-disabled")});$('#nao_idioma').on('click',function(){$('#novo_idioma').css("display","block")});$('#sim_idioma').on('click',function(){$('#novo_idioma').css("display","none")});$('#sim_emprego').on('click',function(){$('.professional_atual').css("display","block");$('.professional_anterior').css("display","none")});$('#nao_emprego').on('click',function(){$('.professional_atual').css("display","none");$('.professional_anterior').css("display","block")});if($('#sim_emprego').prop("checked")){$('.professional_atual').css("display","block");$('.professional_anterior').css("display","none")}else if($('#nao_emprego').prop("checked")){$('.professional_atual').css("display","none");$('.professional_anterior').css("display","block")}
$('#sim_deficiencia').on('click',function(){$('.deficiencia').css("display","block");$('.deficiencia_nao').css("display","none");$('.success-enabled').css("display","block")});$('#nao_deficiencia').on('click',function(){$('.deficiencia').css("display","none");$('.deficiencia_nao').css("display","block");$('.success-enabled').css("display","none")});if($('#sim_deficiencia').prop("checked")){$('.deficiencia').css("display","block");$('.success-enabled').css("display","block")}else if($('#nao_deficiencia').prop("checked")){$('.deficiencia').css("display","none");$('.success-enabled').css("display","none")}
$('#simadaptacoes').on('click',function(){$('.adaptacao').css("display","block")});$('#naoadaptacoes').on('click',function(){$('.adaptacao').css("display","none")});if($('#simadaptacoes').prop("checked")){$('.adaptacao').css("display","block")}else if($('#naoadaptacoes').prop("checked")){$('.adaptacao').css("display","none")}});$(document).ready(function(){$('#nivel').on("change",function(){let nivel=$('#nivel').val();var view;if(nivel=="Iniciante"){view='<div>*Iniciante:</br>Você não tem conhecimento algum do idioma, mas em breve você poderá dar os primeiros passos rumo ao progresso.</div>'}else if(nivel=="Basico"){view='<div>*Básico:</br>Você já poderá formar e entender questões simples.</div>'}else if(nivel=="Elementar"){view='<div>*Elementar:</br>Você poderá entender simples artigos de jornal. Escrever cartas e fazer declarações espontâneas não são problemas.</div>'}else if(nivel=="Intermediario"){view='<div>*Intermediário:</br>Você já terá conhecimento prévio detalhado de gramática e vocabulário.</div>'}else if(nivel=="Avancado"){view='<div>*Avançado:</br>Você tem um conhecimento grande do idioma. Você poderá apresentar tópicos específicos e conversar em quase quaisquer assuntos.</div>'}else if(nivel=="Fluente"){view='<div>*Fluente:</br>Você terá técnicas especiais de vocabulário e gramática. Você poderá se comunicar em alto nível.</div>'}else if(nivel=="Academico"){view='<div>*Acadêmico:</br>Você terá o perfeito conhecimento de vocabulário e gramática. Você poderá se comunicar quase como um falante nativo.</div>'}else{view='<div></div>';$(".success-disabled").html(view)}
$(".success-enabled").html(view)});$('#tipo_deficiencia').on("change",function(){let tipo_deficiencia=$('#tipo_deficiencia').val();var view;if(tipo_deficiencia=="Auditiva"){view='<div>*Deficiência Auditiva:</br>'+'Deficiência auditiva (perda auditiva) é quando a habilidade auditiva da pessoa é reduzida. Deficiência auditiva faz com que a '+'pessoa tenha dificuldade de ouvir diálogos e outros sons.  As causas mais comuns de deficiência auditiva (perda auditiva) são ruídos e envelhecimento.'+'</div>'}else if(tipo_deficiencia=="Fisica"){view='<div>*Deficiência Fisica:</br>'+'São complicações que levam à limitação da mobilidade e da coordenação geral, podendo também afetar a fala, em diferentes graus. As causas são variadas - desde lesões neurológicas e neuromusculares'+' até má-formação congênita - ou condições adquiridas, como hidrocefalia (acúmulo de líquido na caixa craniana) ou paralisia cerebral.'+'</div>'}else if(tipo_deficiencia=="Mental"){view='<div>*Deficiência Mental:</br>'+'Segundo a AAMR (Associação Americana de Deficiência Mental) e DSM-IV (Manual Diagnóstico e Estatístico de Transtornos Mentais), pode-se definir deficiência mental como o estado de redução notável do '+'funcionamento intelectual inferior à média, associado a limitações pelo menos em dois aspectos do funcionamento adaptativo: comunicação, cuidados pessoais, competência domésticas, '+'habilidades sociais, utilização dos recursos comunitários, autonomia, saúde e segurança, aptidões escolares, lazer e trabalho.</div>'}else if(tipo_deficiencia=="Multipla"){view='<div>*Deficiência Multipla:</br>'+'A associação de duas ou mais deficiências caracteriza uma pessoa com essa condição. A deficiência múltipla pode ser tanto mental, '+'física ou sensorial, que combinadas acarretam em atrasos na capacidade adaptativa e no desenvolvimento global do indivíduo. Essa definição '+'é da Política Nacional de Educação Especial do Ministério da Educação, que está cada vez mais engajado para fazer valer os direitos das pessoas com deficiência..</div>'}else if(tipo_deficiencia=="Visual"){view='<div>*Deficiência Visual:</br>'+'É o comprometimento parcial (de 40 a 60%) ou total da visão. Não são deficientes visuais pessoas com doenças como miopia, astigmatismo ou hipermetropia, '+'que podem ser corrigidas com o uso de lentes ou em cirurgias.Segundo critérios estabelecidos pela Organização Mundial da Saúde (OMS)'+' os diferentes graus de deficiência visual podem ser classificados em: Baixa visão (leve, moderada ou profunda), Próximo à cegueira e Cegueira'+'</div>'}else if(tipo_deficiencia=="Outros"){view='<div>*Outros:</br>Autismo ou Reabilitado do INSS</div>'}else{view='<div></div>';$(".success-disabled").html(view)}
$(".success-enabled").html(view)})});$('#uf').on('change',function(){var idUf=$('#uf').val();var url="<?php echo getCitsStates(); ?>";console.log(idUf);$.ajax({url:url,type:'POST',data:"id_estado="+idUf,beforeSend:function(){$('#city').html('carregando...')},success:function(data){console.log(data);$('#city').html(data)},error:function(data){$('#city').html('Erro ao carregar!')}})});$(document).ready(function(){$(function(){$('#btncopia').click(function(){$('#link').select();var copy=document.execCommand('copy');if(copy){var view='<div class="message success"> Sucesso ao Copiar Link </div>';$(".alert_copy").html(view);$(".message").effect("bounce");return}else{var view='<div class="message error"> Erro ao copiar, seu navegador pode não ter suporte a essa função.</div>';$(".alert_copy").html(view);$(".message").effect("bounce")}
return!1})})});$(document).ready(function(){$('#filtro').on("change",function(){let filtro=$('#filtro').val();if(filtro=="Formação"){$('#conhecimento').css("display","none");$('#selecao').css("display","none");$('#formacao').css("display","block");$('#deficiencia').css("display","none");$('#idiomas').css("display","none");$('#sexo').css("display","none")}else if(filtro=="Sexo"){$('#conhecimento').css("display","none");$('#selecao').css("display","none");$('#formacao').css("display","none");$('#deficiencia').css("display","none");$('#idiomas').css("display","none");$('#sexo').css("display","block")}else if(filtro=="PCD"){$('#conhecimento').css("display","none");$('#deficiencia').css("display","block");$('#selecao').css("display","none");$('#formacao').css("display","none");$('#idiomas').css("display","none");$('#sexo').css("display","none")}else if(filtro=="Conhecimento"){$('#conhecimento').css("display","block");$('#deficiencia').css("display","none");$('#selecao').css("display","none");$('#formacao').css("display","none");$('#idiomas').css("display","none");$('#sexo').css("display","none")}else if(filtro=="Idioma"){$('#conhecimento').css("display","none");$('#deficiencia').css("display","none");$('#selecao').css("display","none");$('#formacao').css("display","none");$('#idiomas').css("display","block");$('#sexo').css("display","none")}else if(filtro==""){$('#conhecimento').css("display","none");$('#deficiencia').css("display","none");$('#selecao').css("display","block");$('#formacao').css("display","none");$('#idiomas').css("display","none");$('#sexo').css("display","none")}})});function verifica_cpf(cpf){var numeros,soma,digitos,i,resultado,digitos_iguais;digitos_iguais=1;cpf=removeMascara(cpf,".");cpf=removeMascara(cpf,"-");if(cpf.length<11)
return!1;for(i=0;i<cpf.length-1;i++)
if(cpf.charAt(i)!=cpf.charAt(i+1)){digitos_iguais=0;break}
if(!digitos_iguais){numeros=cpf.substring(0,9);digitos=cpf.substring(9);soma=0;for(i=10;i>1;i--)
soma+=numeros.charAt(10-i)*i;resultado=soma%11<2?0:11-soma%11;if(resultado!=digitos.charAt(0))
return!1;numeros=cpf.substring(0,10);soma=0;for(i=11;i>1;i--)
soma+=numeros.charAt(11-i)*i;resultado=soma%11<2?0:11-soma%11;if(resultado!=digitos.charAt(1))
return!1;return!0}else return!1}
jQuery(document).ready(function($){$('#camp_cpf').on("input",function(e){e.preventDefault();let cpf=$('#camp_cpf').val();if(verifica_cpf(cpf)){$('#cpf').attr("class"," has-success col-md-4");$('#mescpf').attr("class","error-disabled")}else{$('#cpf').attr("class","has-error col-md-4");$('#mescpf').attr("class","error-enabled")}});$('#campo_email').on("input",function(e){e.preventDefault();let email=$('#campo_email').val();let validarEmail=/^[a-zA-Z0-9][a-zA-Z0-9\._-]+@([a-zA-Z0-9\._-]+\.)[a-zA-Z-0-9]{2}/;if(validarEmail.test(email)==!1){$('#email').attr("class"," has-error");$('#upemail').attr("class"," has-error col-md-6");$('#mesmeail').attr("class","error-enabled")}else{$('#email').attr("class","has-success");$('#upemail').attr("class","has-success col-md-6");$('#mesmeail').attr("class","error-disabled")}});$("#cad_email").on("input",function(e){e.preventDefault();let campo_email=$('#campo_email').val();let confirmaemail=$('#confirmaemail').val();if(campo_email==confirmaemail){$('#email').attr("class","has-success");$('#confirma_email').attr("class","has-success");$('#mesmeail_conf').attr("class","error-disabled")}else{$('#confirma_email').attr("class","has-error");$('#mesmeail_conf').attr("class","error-enabled")}});$("#cad_senha").on("input",function(e){e.preventDefault();let senha=$('#senha').val();let confirma_senha=$('#confirma_senha').val();let atual_senha=$('#senhatual').val();if(senha==confirma_senha){$('#div_confsenha').attr("class","has-success");$('#div_senha').attr("class","has-success");$('#mesenha_conf').attr("class","error-disabled")}else{$('#div_confsenha').attr("class","has-error");$('#div_senha').attr("class","has-error");$('#mesenha_conf').attr("class","error-enabled")}
if(senha!=atual_senha){$('#mesenha_atual').attr("class","error-disabled")}else{$('#mesenha_atual').attr("class","error-enabled")}})});function format(mascara,documento){var i=documento.value.length;var saida=mascara.substring(0,1);var texto=mascara.substring(i);if(texto.substring(0,1)!=saida){documento.value+=texto.substring(0,1)}}