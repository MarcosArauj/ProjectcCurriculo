...
$(".success-enabled").html(view)})});$('#uf').on('change',function(){var idUf=$('#uf').val();var url="<?php echo getCitsStates(); ?>";console.log(idUf);$.ajax({url:url,type:'POST',data:"id_estado="+idUf,beforeSend:function(){$('#city').html('carregando...')},success:function(data){console.log(data);$('#city').html(data)},error:function(data){$('#city').html('Erro ao carregar!')}})});function verifica_cpf(cpf){var numeros,soma,digitos,i,resultado,digitos_iguais;digitos_iguais=1;cpf=removeMascara(cpf,".");cpf=removeMascara(cpf,"-");if(cpf.length<11)
