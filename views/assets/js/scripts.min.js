...
return!1})})});$(document).ready(function(){$('#filtro').on("change",function(){let filtro=$('#filtro').val();if(filtro=="Formação"){$('#busca').val('Digite a formação acadêmica desejada');$('#busca').attr('disabled',!1)}else if(filtro=="Sexo"){$('#busca').val('Digite um Sexo');$('#busca').attr('disabled',!1)}else if(filtro=="PCD"){$('#busca').val('Digite o tipo de deficiência desejado');$('#busca').attr('disabled',!1)}else if(filtro=="Conhecimento"){$('#busca').val('Digite area de conhecimento desejada');$('#busca').attr('disabled',!1)}else if(filtro=="Idioma"){$('#busca').val('Digite um Idioma');$('#busca').attr('disabled',!1)}else if(filtro==""){$('#busca').val('');$('#busca').attr('disabled',!0)}})});function verifica_cpf(cpf){var numeros,soma,digitos,i,resultado,digitos_iguais;digitos_iguais=1;cpf=removeMascara(cpf,".");cpf=removeMascara(cpf,"-");if(cpf.length<11)
