...
jQuery(document).ready(function($){$('#camp_cpf').on("input",function(e){e.preventDefault();let cpf=$('#camp_cpf').val();if(verifica_cpf(cpf)){$('#cpf').attr("class"," has-success col-md-4");$('#mescpf').attr("class","error-disabled")}else{$('#cpf').attr("class","has-error col-md-4");$('#mescpf').attr("class","error-enabled")}});$('#campo_email').on("input",function(e){e.preventDefault();let email=$('#campo_email').val();let validarEmail=/^[a-zA-Z0-9][a-zA-Z0-9\._-]+@([a-zA-Z0-9\._-]+\.)[a-zA-Z-0-9]{2}/;if(validarEmail.test(email)==!1){$('#email').attr("class"," has-error col-md-12");$('#upemail').attr("class"," has-error col-md-6");$('#mesmeail').attr("class","error-enabled")}else{$('#email').attr("class","has-success col-md-12");$('#upemail').attr("class","has-success col-md-6");$('#mesmeail').attr("class","error-disabled")}});$("#cad_email").on("input",function(e){e.preventDefault();let campo_email=$('#campo_email').val();let confirmaemail=$('#confirmaemail').val();if(campo_email==confirmaemail){$('#email').attr("class","has-success col-md-12");$('#confirma_email').attr("class","has-success col-md-12");$('#mesmeail_conf').attr("class","error-disabled")}else{$('#confirma_email').attr("class","has-error col-md-12");$('#mesmeail_conf').attr("class","error-enabled")}});$("#cad_senha").on("input",function(e){e.preventDefault();let senha=$('#senha').val();let confirma_senha=$('#confirma_senha').val();let atual_senha=$('#senhatual').val();if(senha==confirma_senha){$('#div_confsenha').attr("class","has-success");$('#div_senha').attr("class","has-success");$('#mesenha_conf').attr("class","error-disabled")}else{$('#div_confsenha').attr("class","has-error");$('#div_senha').attr("class","has-error");$('#mesenha_conf').attr("class","error-enabled")}
if(senha!=atual_senha){$('#mesenha_atual').attr("class","error-disabled")}else{$('#mesenha_atual').attr("class","error-enabled")}})});function formatar(mascara,documento){var i=documento.value.length;var saida=mascara.substring(0,1);var texto=mascara.substring(i);if(texto.substring(0,1)!=saida){documento.value+=texto.substring(0,1)}};(function(){'use strict'
feather.replace()
