...
<section class="container col-md-8" >
   <div class="card border-success" style="color: black;">
     ...
     <div class="card-body">
       <div class="row">
           <?php if( $curriculum["foto_usuario"] == '/views/assets/images/user/user' ){ ?>
           <div class="col-3">
           ...
           <div class="col-9">
               ...
               <div class="col">
                   <div class="row">
                       ...
                       <span><?php echo htmlspecialchars( $curriculum["endereco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, Nº <?php echo htmlspecialchars( $curriculum["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                       <span class="offset-1"></span>
                       <label><b>CEP: </b></label>&nbsp;
