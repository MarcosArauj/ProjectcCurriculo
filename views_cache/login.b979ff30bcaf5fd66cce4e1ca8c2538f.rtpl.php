...
<?php require $this->checkTemplate("navbar_login");?>
                    ...
                    <form class="form" action="/login" method="post" autocomplete="off">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Usuário - E-mail"  name="login"  id="login" autofocus
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button class="btn btn-success" id="entrar"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;&nbsp;Entrar</button>
                        </div>
                    </form>
                </div>
