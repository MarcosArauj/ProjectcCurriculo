    ...
    <section>
        ...
        <?php } ?>
            ...
            <?php } ?>
                ...
                <div>
                    <label><b>Idioma: </b></label><?php echo htmlspecialchars( $value1["idioma"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["nivel_conhecimento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
