                            ...
                            <form class="form" action="/register" method="post" autocomplete="off">
                                <div id="cad_email">
                                    <div id="email" class="form-group">
                                        <strong class="obrigatorio">*</strong><b class="text-white">E-mail</b>&nbsp;&nbsp; <strong id="mesmeail" class="error-disabled" ><span class="h6">E-mail inválido!!!</span></strong>
