                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="ano_inicio_conclusao" name="ano_inicio_conclusao" placeholder="Ex: 1999" onkeypress="formatar('####',this)"  maxlength="4">
                            </div>
                            <div class="form-group col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="ano_inicio_andamento" name="ano_inicio_andamento" placeholder="Ex: 1999" onkeypress="formatar('####',this)"  maxlength="4">
                            </div>
