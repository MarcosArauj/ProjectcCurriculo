                ...
                <div class="col">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm" id="primeiro_nome" name="primeiro_nome" placeholder="Digite seu nome">
                        </div>
                        <div class="form-group col-md-5">
                            <label for="sobrenome"><strong class="obrigatorio">*</strong><b>Sobrenome</b></label>
                            <input type="text" class="form-control form-control-sm" id="sobrenome" name="sobrenome" placeholder="Digite seu sobrenome">
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label for="nacionalidade"><strong class="obrigatorio">*</strong><b>País de Naciscimento</b></label>
                            <select class="form-control form-control-sm" id="nacionalidade" name="nacionalidade" >
                                <option value="">Selecione</option>
                        ...
                        <div class="form-group col-md-3">
                            <label  for="uf_naturalidade"><strong class="obrigatorio">*</strong><b>Estado</b></label>
                            <select class="form-control form-control-sm" name="uf_naturalidade" id="uf_naturalidade">
                                <option value="">Selecione</option>
                                <?php $counter1=-1;  if( isset($uf) && ( is_array($uf) || $uf instanceof Traversable ) && sizeof($uf) ) foreach( $uf as $key1 => $value1 ){ $counter1++; ?>
                                <option value="<?php echo htmlspecialchars( $value1["uf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["nome_estado"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            <label  for="naturalidade"><strong class="obrigatorio">*</strong><b>Naturalidade</b></label>&nbsp;&nbsp;
                            <span class="carregando">Aguarde, carregando...</span>
                            <select class="form-control form-control-sm" id="naturalidade" name="naturalidade" disabled>
                                <option value="">-- Selecione um estado --</option>
                            </select>
                        </div>
                        <div class="form-group col-md-2">
                            <label  for="cor"><strong class="obrigatorio">*</strong><b>Cor ou Raça</b></label>
                            <select class="form-control form-control-sm" name="cor_raca" id="cor">
                                <option value="">Selecione</option>
