    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?php if( $value1["foto_usuario"] != 'photo_user' ){ ?>
                    <div class="col-md-3">
            ...
            <div class="modal-footer">
                <a href="<?php echo site('root'); ?>/curriculum/<?php echo htmlspecialchars( $value1["cod_curriculo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"  class="btn btn-primary btn-sm" target="_blank"> Abrir Currículo</a>
