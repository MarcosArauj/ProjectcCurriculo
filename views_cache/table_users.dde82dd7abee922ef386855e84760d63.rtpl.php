...
<table class="table table-striped border-success">
        ...
        <tr>
            ...
            <td class="float-right">
                ...
                <button class="btn btn-primary btn-sm"><i class="fa fa-refresh"></i> Resetar Senha</button>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <p><b>Deseja realmente excluir este Usuário?</b></p>
                    </div>
                    <div class="modal-footer">
                        <form class="form" action="/admin/<?php echo htmlspecialchars( $value1["id_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" method="post">
