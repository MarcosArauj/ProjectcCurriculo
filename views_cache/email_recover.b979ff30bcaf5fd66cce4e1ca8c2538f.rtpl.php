                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title"><b>Recupera&ccedil;&atilde;o de Senha</b></td>
                                    </tr>
                                </table>
                                <table class="body">
                                    <tr>
                                        ...
                                        <td class="body-padded">
                                            <div class="body-title">Ol&aacute; Marcos,</div>
                                            <table class="body-text">
                                                ...
                                                <tr>
                                                    <td class="body-text-cell">
                                                        O link é válido por 24 horas. Após esse tempo expirar, <br>
                                                        precisará reenviar a solicitação de redefinição para a senha.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><a id="btn-redefine" href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>" align="center">Redefinir Senha</a></td>
                                                </tr>
                                            </table>
