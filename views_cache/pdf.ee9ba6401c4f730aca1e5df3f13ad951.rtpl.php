...
<main role="main">
    <?php if( $curriculum ){ ?>
    <section>
        <?php if( $curriculum["foto_usuario"] != 'photo_user' ){ ?>
        ...
        <?php } ?>
            ...
            <?php } ?>
                ...
                <div>
                    ...
                    <label><b>País de Nascimento: </b></label><?php echo htmlspecialchars( $curriculum["nacionalidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?>;
                </div>
                <hr>
                <!-- Contato -->
                <div>
                ...
                <div>
                    <label><b>Rua/Av: </b></label><?php echo htmlspecialchars( $curriculum["endereco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, Nº <?php echo htmlspecialchars( $curriculum["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&nbsp;&nbsp;&nbsp;
