        ...
        <div  class="card bg-dark">
            ...
            <div class="card-footer">
                ...
                <div class="float-right">
                    ...
                    <a class="btn btn-secondary" href="/user/professional_experience" title="Listar"> Listar Experiência <i class="fa fa-list-ul" aria-hidden="true"></i> </a>
                    <a class="btn btn-primary" href="/user/curriculum/create" title="Próximo"> Finalizar <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> </a>
                </div>
            </div>
        </div>
    </section>
