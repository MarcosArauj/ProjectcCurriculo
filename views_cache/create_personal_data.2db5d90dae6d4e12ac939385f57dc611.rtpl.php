                ...
                <div class="col">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control form-control-sm" name="uf_naturalidade" id="estado" required>
                                <option value="">Selecione</option>
                        ...
                        <div class="form-group col-md-4">
                            <label  for="cidade"><strong class="obrigatorio">*</strong><b>Naturalidade</b></label>&nbsp;&nbsp;
                            <span class="carregando">Aguarde, carregando...</span>
                            <select class="form-control form-control-sm" id="cidade" name="naturalidade"  required>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label  for="rg"><strong class="obrigatorio">*</strong><b>RG</b></label>
