    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-danger" href="/user" title="Anterior"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Voltar </a>
                <?php }else{ ?>

                <a class="btn btn-danger" href="/user/professional_experience/create" title="Anterior"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Voltar </a>
                <?php } ?>
