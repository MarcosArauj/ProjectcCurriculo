    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="float-right">
                ...
                <a href="<?php echo htmlspecialchars( $value1["id_profissional"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/professional_experience" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                <a href="/curriculum/<?php echo htmlspecialchars( $value1["id_profissional"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/professional_experience_delete" onclick="return confirm('Deseja realmente excluir este Experiência Profissional?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Excluir</a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
