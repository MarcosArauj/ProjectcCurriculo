                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title"><b>Suporte - <?php echo htmlspecialchars( $site, ENT_COMPAT, 'UTF-8', FALSE ); ?></b></td>
                                    </tr>
                                </table>
                                <table class="body">
                                    <tr>
                                            ...
                                            <table class="body-text">
                                                <tr>
                                                    <td class="body-text-cell">
                                                        Sua solicitação está sendo analisada. </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><b>Você terá sua solução em até 2 dias! </b></td>
                                                </tr>
                                            </table>
