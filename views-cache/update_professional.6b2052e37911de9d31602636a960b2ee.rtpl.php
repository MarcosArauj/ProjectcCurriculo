...
<form class="form" action="/curriculum//<?php echo htmlspecialchars( $professional["id_profissional"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/professional_experience" method="post" autocomplete="off">
