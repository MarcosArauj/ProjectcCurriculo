...
<form class="form" action="/curriculum/<?php echo htmlspecialchars( $courses["id_cursos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/other_courses" method="post" autocomplete="off">
    <div  class="card border-success">
        ...
        <div class="card-footer">
            ...
            <div class="float-right">
               <button class="btn btn-md btn-success"> Atualizar Curso</button>
            </div>
        </div>
