...
<form class="form" action="/curriculum/formation" method="post" autocomplete="off">
    <div  class="card border-success">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control form-control-sm" id="ano_inicio_conclusao" name="ano_inicio_conclusao" placeholder="Ex: 19999" value="<?php echo htmlspecialchars( $user["ano_inicio_conclusao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onkeypress="formatar('####',this)"  maxlength="4">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="ano_conclusao"><b>Conclusão(Ano)</b></label>
                            <input type="text" class="form-control form-control-sm" id="ano_conclusao" name="ano_conclusao" placeholder="Ex: 2010" value="<?php echo htmlspecialchars( $user["ano_conclusao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onkeypress="formatar('####',this)"  maxlength="4" >
                        </div>
        ...
        <div class="card-footer">
            <a class="btn btn-danger float-left" href="/user/deficiency_update" title="Anterior"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Anterior </a>
            <div class="row float-right">
                <button class="btn btn-md btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i> Atualizar Formação Acadêmica</button>&nbsp;
